...
def Data_Classification():
    ...
    with open("Lesker_Batch_Number.csv", "wb") as Lesker_Batch_Number_file:
    ...
    with open("Lesker_Substrate_I.csv", "wb") as Lesker_Substrate_I_file:
    ...
    with open("Lesker_Substrate_F.csv", "wb") as Lesker_Substrate_F_file:
    ...
    with open("VG_Batch_Number.csv", "wb") as VG_Batch_Number_file:
